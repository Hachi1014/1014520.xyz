...
export default function ExploreLayout({ children }: { children: React.ReactNode }) {
  return <div className="blog-shell"><a className="skip-link" href="#explore-content">跳到正文</a>
    <header className="blog-header">
      <div className="header-brand"><a className="wordmark" href="/"><span className="dot-mark" aria-hidden="true" />zhangboyang.</a></div>
      <nav aria-label="主导航"><a href="/">首页</a><a href="/blog">博客</a><a href="/#thoughts">想法</a><a href="/#daily">日常</a><a href="/explore" aria-current="page">Explore</a></nav>
